...
// route pour publier les annonces
router.post("/offer/publish", isAuthenticated, async (req, res) => {
  try {
    ...
    // Déclaration d'une nouvelle offre newOffer
    ...
    // Uploader l'image presente dans cloudinary
...
// Route pour recevoir des offres
...
// Route pour recevoir l'offre en fonction de l'ID
